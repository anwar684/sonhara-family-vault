...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (email === 'admin@sonhara.com' && password === 'admin123') {
        toast({
          title: 'Welcome back!',
        ...
        toast({
          title: 'Welcome!',
          description: 'You have been logged in as Member.',
        });
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 p-4 rounded-lg bg-muted/50 border border-border">
            ...
            <div className="space-y-1 text-sm">
              <p><span className="font-medium">Admin:</span> admin@sonhara.com / admin123</p>
              <p><span className="font-medium">Member:</span> Any email / any password</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="relative z-10 max-w-md text-center">
          ...
          <div className="mt-8 grid grid-cols-2 gap-4">
            <div className="bg-primary-foreground/10 backdrop-blur rounded-xl p-4">
              <p className="text-2xl font-bold text-gold font-serif">Takaful</p>
              <p className="text-sm text-primary-foreground/70">Donation Fund</p>
            </div>
            <div className="bg-primary-foreground/10 backdrop-blur rounded-xl p-4">
              <p className="text-2xl font-bold text-gold font-serif">Plus</p>
              <p className="text-sm text-primary-foreground/70">Investment Fund</p>
            </div>
          </div>
        </div>
      </div>
